...
public class CreateNewCourierTest {
    ...
    public void courierCanBeCreatedTest() {
        ...
        courier.createCourier(courierRequest).assertThat().statusCode(SC_CREATED).and().assertThat().body("ok", is(true));
    ...
    public void sameDataCourierCreationTest() {
        ...
        courierId = courier.login(loginRequest)
                ...
                .extract()
                .path("id");
        courier.createCourier(courierRequest).assertThat().statusCode(SC_CONFLICT);
    }
    ...
    public void courierWithoutLoginCreationTest() {
        ...
        courier.createCourier(courierRequest).assertThat().statusCode(SC_BAD_REQUEST);
    }
